...
const probMatrix = [
  ...
  // Use roomsList dynamically
  const initial_rooms2 = typeof roomsList !== 'undefined' ? roomsList : ['Living Room', 'Bathroom', 'Kitchen', 'CommonRoom', 'Balcony', 'MasterRoom'];

  console.log(initial_rooms2); // This will show the dynamic list received from Flask
